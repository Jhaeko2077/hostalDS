<?php
// Verificar sesión de administrador (solo administradores)
session_start();
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
    ...
    <div class="mb-8 flex justify-between items-center animate-slide-down">
        <div>
            <h1 class="text-4xl font-bold text-gray-dark mb-2 flex items-center space-x-3">
                <i class="ph ph-shield-star text-primary animate-bounce-subtle"></i>
                <span>Gestión de Administradores</span>
            </h1>
            <p class="text-gray-dark/70">Administra las cuentas de administradores</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 mb-8 animate-scale-in">
        ...
        <form action="administrador_crud.php" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-dark mb-2">
                        <i class="ph ph-user-circle text-primary"></i> Usuario (debe existir en Empleado)
                    </label>
            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-light hover:bg-gray-light/50 transition-colors duration-200">
                        <form action="administrador_crud.php" method="POST" class="contents">
                            <td class="py-3 px-4">
                            ...
                            <td class="py-3 px-4">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <a href="administrador_crud.php?eliminar=<?= htmlspecialchars($row['id']) ?>" 
