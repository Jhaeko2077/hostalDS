            ...
            <div class="text-center mb-8">
                <div class="flex justify-center mb-4">
                    <div class="bg-primary/10 p-4 rounded-full">
                        <i class="ph ph-user-circle text-primary text-6xl animate-bounce-subtle"></i>
                    </div>
                </div>
                <h2 class="text-3xl font-bold text-gray-dark mb-2">Bienvenido Cliente</h2>
                <p class="text-gray-dark/70">Inicia sesión en tu cuenta</p>
            </div>

            <!-- Formulario -->
            <form action="validar_cliente.php" method="POST" class="space-y-6">
                <div class="space-y-4">
                    <div>
